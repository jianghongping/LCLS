function [offset_theta] = get_offset_theta_redo(simage, imagename, saxsi, xc, yc, raz, dtheta,...
...
auto_offset = '1';
    ...
    while ~isempty(auto_offset);    
        ...
        az_display1 = azimuthal_masked_strict(saxsi, xc, yc, dtheta, raz, window, th_st1, th_ed1);
        az_display2 = azimuthal_masked_strict(saxsi, xc, yc, dtheta, raz, window, th_st2, th_ed2);
