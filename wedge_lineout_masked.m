function [qvec,IntI,darc,gaps]=wedge_lineout_masked(image,energy,SDD,pix,center,thetamin,thetamax,thetasteps,rmax,offset)

[I,darc]=rectslice_masked(image,center(1),center(2),thetamin,thetamax,thetasteps,rmax,offset);
